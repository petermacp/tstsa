...
mdata_imp %>% janitor::tabyl(hiv_i) %>% gt()
mdata_imp %>% janitor::tabyl(hivfinal_h) %>% gt()
mdata_imp %>% janitor::tabyl(timespent_h) %>% gt()
...
tdata_out <- bind_rows(five_mm2, ten_mm2)
