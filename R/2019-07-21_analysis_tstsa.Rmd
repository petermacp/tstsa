...
ps2 <- posterior_samples(fit1, "b_hivfinal_hContactHIVPve")
colMeans(ps2 < 0)
...
ggsave(here("figures/figure_1.pdf"), width = 12, height = 12, dpi=1200, device = cairo_pdf)
...
ps2 <- posterior_samples(fit2, "b_hivfinal_hContactHIVPve")
colMeans(ps2 < 0)
...
ggsave(here("figures/figure_1_alt.png"), width = 12, height = 12, dpi=1200)
